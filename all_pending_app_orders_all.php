...
<body>
    ...
    function fetchtable() {
        ...
        console.log("<?php echo $api_url; ?>get/get_all_pending_app_orders_all.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&rettype="+rettypes+"");
        fetch("<?php echo $api_url; ?>get/get_all_pending_app_orders_all.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&rettype="+rettypes+"",
                requestOptions)
            .then(response => response.json())
            .then(response => {
                // console.log(response)
                ...
                $.each(response, function(index, data) {
                    ...
                    if (legder_balance <= 0 && order_amount > credit_limit) {
                        ...
                        console.log("Order approved"); // Replace this with your action for approving the order
