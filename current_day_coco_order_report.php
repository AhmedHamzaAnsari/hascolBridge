        ...
        <div class="main-content">
            <div class="page-content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h3 id="report_header">COCO Orders Current Day of <span id="report_date"></span></h3></span>
    ...
    $(document).ready(function() {
        ...
        table = $('#myTable').DataTable({
            ...
            buttons: [{
                    extend: 'copyHtml5',
                    title: function() {
                        return 'COCO Orders Current Day of ' + $('#report_date').text();
                    }
                },
                {
                    extend: 'excelHtml5',
