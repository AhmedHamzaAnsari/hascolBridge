                    ...
                    for (var i = 0; i < dealers.length; i++) {
                        ...
                        if (dealerData.length > 0) {
                            for (const item of dealerData) {
                                ...
                                try {
                                    console.log(`<?php echo $api_url; ?>get/get_dealers_recons_product_wise.php?key=03201232927&dealer_id=${dealer_id}&from=${from}&to=${to}&products=${products}&tm_id=${tm_id}`);
                                    let reconResponse = await fetch(
                                        `<?php echo $api_url; ?>get/get_dealers_recons_product_wise.php?key=03201232927&dealer_id=${dealer_id}&from=${from}&to=${to}&products=${products}&tm_id=${tm_id}`
                                    );
