                ...
                .then(response => {
                    ...
                    $.each(response, function (index, data) {
                        ...
                        table.row.add([
                            ...
                            data.tm_name,
                            data.asm_name,
                            '<td><a type="button" id="View" name="view" href="dealers_acount_profile.php?id=' + encodeURIComponent(encryptedId) + '" target="_blank" class="btn btn-soft-warning waves-effect waves-light"><i class="fas fa-eye font-size-16 align-middle"></i></a></td>'
                        ]).draw();
