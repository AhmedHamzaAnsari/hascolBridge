...
<body>
    ...
    <div class="offcanvas offcanvas-end w-75" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
        <div class="offcanvas-header border-bottom">
            <h5 id="offcanvasRightLabel">Create Depots</h5>
            ...
            <div class="container-fluid">
                <form method="post" id="insert_form" enctype="multipart/form-data">
                    ...
                    <div class="form-row row mb-4">
                        ...
                        <div class="form-group col-md-2">
                            <label for="inputEmail4">Depot SAP #</label>
                            <span id="lorry_span">
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#insert_form').on("submit", function (event) {
                ...
                if (update_id == 0) {
                    ...
                    $.ajax({
                        url: "<?php echo $api_url; ?>create/create_depots.php",
                        cache: false,
                        contentType: false,
                        processData: false,
                        method: "POST",
        ...
        function fetchtable() {
            ...
            console.log("<?php echo $api_url; ?>get/depots.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>");
            fetch("<?php echo $api_url; ?>get/depots.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
                ...
                .then(response => {
                    ...
                    $.each(response, function (index, data) {
                        ...
                        table.row.add([
                            ...
                            // 23434,
                            // 23434,
                            '<a type="button"id="View" name="view" href="depot_profile.php?id=' +
