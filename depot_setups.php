                                        ...
                                        <table id="tanks_table" class="display" style="width:100%">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Current Rreading</th>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    ...
                                    <select name="products" class="form-select" id="dealer_products"
                                        onchange="product_tankss(this.value,'1',this.id)">
                                ...
                                <div class="col-4">
                                    ...
                                    <input type="text" class="form-control" name="lorry_no" id="lorry_no" value=""
                                        readonly>
                                </div>
                                ...
                                <div class="col-4">
                                    <label for="">Current Dip</label>
                                    <input type="number" class="form-control" name="current_dip" value="0">
                                </div>
                                <div class="col-4">
                                    <label for="">Current Reading</label>
                                    <input type="number" class="form-control" name="current_reading" value="0">
                                </div>
                                <div class="col-4">
                                    <label for="">Current Temperature</label>
                                    <input type="number" class="form-control" name="current_temperature" value="0">
                                </div>
                                \<div class="col-4">
                                    <label for="">Current Available stock</label>
                                    <input type="number" class="form-control" name="current_available_stock" value="0">
                                </div>
                        ...
                        <form method="post" id="tank_dip_form" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="mb-3 row">
                                        <label for="example-text-input" class="col-md-2 col-form-label">Reading</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" id='new_dip_reading'
                                                name='new_dip_reading' required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                        <label for="example-text-input"
                                            class="col-md-2 col-form-label">Temperature</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" id='dip_temprature' name='dip_temprature'
                                                required>
                                        </div>
                                    </div>
                                    <div class="mb-3 row">
                                ...
                                <div class="col-12" style="text-align: right;">
                                    ...
                                    <input type="hidden" name="old_dip_reading" id='old_dip_reading' value="">
                                    <input type="hidden" name="current_available_stock" id='current_available_stock' value="">
                                    <input type="hidden" name="row_id">
                                    <button type="button" class="btn btn-secondary waves-effect"
                                        data-bs-dismiss="modal">Close</button>
...
tanks_table = $('#tanks_table').DataTable({
    dom: 'Bfrtip',
...
function fetchtable() {
    ...
    fetch("<?php echo $api_url; ?>get/depot_profile.php?id=" + decryptedId + "&key=03201232927", requestOptions)
...
function tanks_view() {
    ...
    console.log("<?php echo $api_url; ?>depots/get/get_depot_tanks.php?key=03201232927&dealer_id=" + decryptedId + "");
    fetch("<?php echo $api_url; ?>depots/get/get_depot_tanks.php?key=03201232927&dealer_id=" + decryptedId + "",
            requestOptions)
        .then(response => response.json())
        .then(response => {
            console.log(response)

            tanks_table.clear().draw();
            var len = response.length;

            if (len > 0) {
                $('#lorry_no').val('Tank_' + (len + 1) + '-');
            } else {
                $('#lorry_no').val('Tank_1-');
            }
            // alert(len)
            if (response.length > 0) {
                ...
                $.each(response, function(index, data) {
                    ...
                    tanks_table.row.add([
                        ...
                        data
                        .id + ',' + data.current_dip +',' + data.current_reading +',' + data.temperature +',' + data.actual_stock +')" class="btn btn-soft-danger waves-effect waves-light"><i class="fas fa-plus-square font-size-16 align-middle"></i></button>',
...
function dealers_products() {
    ...
    fetch("<?php echo $api_url; ?>depots/get/depo_products.php?key=03201232927&dealer_id=" + decryptedId + "",
            requestOptions)
        .then(response => response.json())
        .then(result => {
...
function facilities() {
    ...
    fetch("<?php echo $api_url; ?>depots/get/get_depot_facilities.php?key=03201232927&dealer_id=" + decryptedId + "",
            requestOptions)
        .then(response => response.json())
        .then(response => {
            console.log(response)
...
function d_dispenser() {
    ...
    fetch("<?php echo $api_url; ?>depots/get/get_depot_dispensor.php?key=03201232927&dealer_id=" + decryptedId + "",
            requestOptions)
        .then(response => response.json())
        .then(response => {
            console.log(response)
...
$('#insert_form').on("submit", function(event) {
    ...
    $.ajax({
        url: "<?php echo $api_url; ?>depots/create/create_depot_facilities.php",
        cache: false,
        contentType: false,
        processData: false,
        method: "POST",
...
$('#dispenser_form').on("submit", function(event) {
    ...
    $.ajax({
        url: "<?php echo $api_url; ?>depots/create/create_depots_dispensor.php",
        cache: false,
        contentType: false,
        processData: false,
        method: "POST",
...
$('#tank_form').on("submit", function(event) {
    ...
    $.ajax({
        url: "<?php echo $api_url; ?>depots/create/create_depot_tanks.php",
        cache: false,
        contentType: false,
        processData: false,
        method: "POST",
...
$('#tank_dip_form').on("submit", function(event) {
    ...
    console.log(formData);
    $.ajax({
        url: "<?php echo $api_url; ?>depots/update/depots_tanks_dip.php",
        type: 'POST',
        data: formData,
        beforeSend: function() {
            $('#dip_btn').val("Saving");
...
$('#productts_form').on("submit", function(event) {
    ...
    console.log(formData);
    $.ajax({
        url: "<?php echo $api_url; ?>depots/create/create_depo_products.php",
        type: 'POST',
        data: formData,
        beforeSend: function() {
...
function add_dip(id,old_dip,old_reading,old_temp,actual_stock) {

    $('#tank_id').val(id)
    $('#old_dip').val(old_dip)
    $('#old_dip_reading').val(old_reading)

    $('#dip_input').val(old_dip)
    $('#new_dip_reading').val(old_reading)

    $('#current_available_stock').val(actual_stock)
...
function get_dip_backlog(id, old_dip) {
    ...
    fetch("<?php echo $api_url; ?>depots/get/get_depot_tanks_dip_log.php?key=03201232927&tank_id=" + id + "", requestOptions)
        .then(response => response.json())
        .then(response => {
            console.log(response)
            $('#order_logs').empty();
            if (response.length > 0) {
                ...
                $.each(response, function(index, data) {
                    ...
                    $('#order_logs').append('<div class="row timeline-right">' +
                        ...
                        '<p class="mb-0 mt-2 pt-1 text-muted">New Dip : ' + data.current_dip +
                        '</p>' +
                        '<p class="mb-0 mt-2 pt-1 text-muted">Previous Reading : ' + data.previous_reading +
                        '</p>' +
                        '<p class="mb-0 mt-2 pt-1 text-muted">New Reading : ' + data.current_reading +
                        '</p>' +
                        '<p class="mb-0 mt-2 pt-1 text-muted">Temperature : ' + data.temperature +
                        '</p>' +
                        '<p class="mb-0 mt-2 pt-1 text-muted">Gain/Loss : ' + data.gain_loss +
                        '</p>' +
                        '<p class="mb-0 mt-2 pt-1 text-muted">Description : ' + data.description +
                        '</p>' +
                        '<p class="mb-0 mt-2 pt-1 text-muted">Action Time : ' + data.created_at +
...
function product_tankss(vals, inc, id) {
    // var product = $('#nozzels_products').val();
    var product = vals;
    var text = $('#' + id).find('option:selected').text();
    // alert(text)

    var selectedProduct = text; // Get the selected product value
    var nozelName = $('#lorry_no').val(); // Get the value of the input type text
    var parts = nozelName.split('-');
    var firstName = parts[0];
    // Concatenate the selected product with the value of the input type text
    var concatenatedText = firstName + '-' + selectedProduct;

    // Set the concatenated text as the value of the input type text
    $('#lorry_no').val(concatenatedText);
}
