                ...
                $.each(result, function(index, data) {
                    div += `<div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="number" class="form-control rate-input" name="rates[]" id="rates_${index}" value="${data.nozel_price}" required>
                        </div>
                        <div class="col-md-3">
                            <label for="inputEmail4">Qty</label>
                            <input type="number" class="form-control qty-input" name="product_qtys[]" id="product_qty_${index}" value="0" required>
                        </div>
                        <div class="col-md-3">
