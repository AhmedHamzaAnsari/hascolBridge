...
<body>
    ...
    <div id="allocate_orders" class="modal fade" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true"
        data-bs-scroll="true">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="myModalLabel">
                        <h5 id="labelc">Order Allocation</h5>
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form method="post" id="realsed_orders" enctype="multipart/form-data">

                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Vehicle</label>
                                    <div class="col-md-10">
                                        <select id="allo_vehicles" name="allo_vehicles"
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <select id="allo_depot" name="allo_depot" class="form-control selectpicker"
                                            required>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-10">
                                        <textarea class="form-control" id="allo_order_description"
                                            name="allo_order_description" rows="4" cols="50" required></textarea>
                                    </div>
                                </div>
                            </div>

                            <div class="col-12 " style="text-align: right;">
                                <input type="hidden" name="allo_order_id" id="allo_order_id">
                                ...
                                <input class="btn btn-primary waves-effect waves-light" type="submit" name="rels_btn"
                                    id="rels_btn" value="Save changes">
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#realsed_orders').on("submit", function (event) {
                event.preventDefault();
                // alert("Name")
                var data = new FormData(this);

                $.ajax({
                    url: "<?php echo $api_url; ?>update/released_orders.php",
                    cache: false,
                    contentType: false,
                    processData: false,
                    method: "POST",
                    ...
                    beforeSend: function () {
                        $('#rels_btn').val("Saving");
                        document.getElementById("rels_btn").disabled = true;
                    ...
                    success: function (data) {
                        ...
                        if (data != 1) {
                            ...
                            $('#rels_btn').val("Save");
                            document.getElementById("rels_btn").disabled = false;
                        } else {
            ...
            $(document).on('click', '.allocations', function () {

                var id = $(this).attr("id");
                // alert(employee_id)
                $('#allo_order_id').val(id);
                $('#allocate_orders').modal('show');
            });
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_all_approved_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
                ...
                .then(response => {
                    ...
                    $.each(response, function (index, data) {
                        ...
                        var order_amount = parseFloat(data.total_amount).toLocaleString();
                        ...
                        if (status == 0) {
                            ...
                            status_value =
                                '<span id=' + data.id +
                                ' class="badge rounded-pill cursor-pointer bg-info allocations" data-key="t-new">Approved</span>';
                        } else if (status == 2) {
                            status_value =
                                '<span id=' + data.id +
                    ...
                    $.each(response, function (index, data) {
                        ...
                        if (parseFloat(data.amount) > parseFloat(data.legder_balance)) {
                            ...
                            if (status == 0) {
                                ...
                                status_value =
                                    '<span id=' + data.id +
                                    ' class="badge rounded-pill cursor-pointer bg-success" data-key="t-new">Blocked</span>';
                            } else if (status == 3) {
                                status_value =
                                    '<span id=' + data.id +
        ...
        function all_selects() {
            ...
            fetch("<?php echo $api_url; ?>get/all_vehicles.php?key=03201232927",
                requestOptions)
                .then(response => response.json())
                .then(result => {
                    var products_name = $("#allo_vehicles");
