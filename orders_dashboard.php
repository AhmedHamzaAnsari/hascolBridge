...
<body>
                            ...
                            <table id="myTable" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">JD Status</th>
    ...
    function fetchtable() {
        ...
        console.log("<?php echo $api_url; ?>get/get_all_main_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>");
        fetch("<?php echo $api_url; ?>get/get_all_main_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
            ...
            .then(response => {
                ...
                var distinctNamesCount = new Set(response.map(function(item) {
                    return item.name;
                })).size;
    ...
    function filterTable() {
        ...
        $.each(filteredData, function(index, data) {
            ...
            // var amounts = parseFloat(parseFloat(data.total_amount).toLocaleString())
            table.row.add([
                index + 1,
                data.created_at,
                data.name,
        ...
        var distinctNamesCount = new Set(filteredData.map(function(item) {
            return item.name;
        })).size;
