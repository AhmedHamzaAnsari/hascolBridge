...
<body>
                ...
                <div class="modal-body">
                    <form method="post" id="approved_orders" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Action</label>
                                    <div class="col-md-10">
                                ...
                                <div class="mb-3 row">
                                    <label for="example-text-input" class="col-md-2 col-form-label">Method</label>
                                    <div class="col-md-10">
                                        <select id="depo_transection" name="depo_transection"
                                            class="form-control selectpicker">
                                            <option selected>Choose...</option>
    ...
    <script>
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_all_pending_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
