...
<body>
    ...
    function fetchtable() {
        ...
        fetch("<?php echo $api_url; ?>get/get_all_retail_forwarded_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>&rettype="+rettypes+"",
                requestOptions)
