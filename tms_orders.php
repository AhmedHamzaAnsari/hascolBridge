...
<body>
    ...
    $(document).ready(function() {
        ...
        $('#approved_orders').on("submit", function(event) {
            ...
            $.ajax({
                url: "<?php echo $api_url; ?>update/processed_orders.php",
                cache: false,
                contentType: false,
                processData: false,
                method: "POST",
    ...
    function fetchtable() {
        ...
        console.log(
            "<?php echo $api_url; ?>get/get_all_pending_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>"
        );
