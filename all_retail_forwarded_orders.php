...
<body>
                            ...
                            <table id="myTable" class="display" style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">D-Type</th>
    ...
    function fetchtable() {
        ...
        console.log("<?php echo $api_url; ?>get/get_all_retailer_forwarded_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>");
        fetch("<?php echo $api_url; ?>get/get_all_retailer_forwarded_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
