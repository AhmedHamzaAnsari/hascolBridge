...
<body>
    ...
    <script>
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_all_special_approval_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
                    ...
                    $.each(response, function (index, data) {
                        ...
                        if (status == 0) {
                           ...
                           if (legder_balance >= order_amount) {
                            ...
                            status_value =
                                '<span id=' + data.id +
                                ' class="badge rounded-pill cursor-pointer bg-dark approved_check" data-key="t-new">Special Approval</span>';
                        } else if (status == 4) {
                            status_value =
                                '<span id=' + data.id +
