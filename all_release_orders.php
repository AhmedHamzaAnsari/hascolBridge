...
<body>
    ...
    <script>
        ...
        function fetchtable() {
            ...
            fetch("<?php echo $api_url; ?>get/get_all_released_order.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
                ...
                .then(response => {
                    ...
                    $.each(response, function (index, data) {
                        ...
                        } else if (order_amount <= credit_limit && legder_balance >= order_amount) {
                            console.log(
                        ...
                        if (status == 0) {
                           ...
                           if (order_amount <= credit_limit && legder_balance >= order_amount) {
                                console.log("Order approved"); // Replace this with your action if conditions are not met
                            ...
                            status_value =
                                '<span id=' + data.id +
                                ' class="badge rounded-pill cursor-pointer bg-primary ' + approved + '" data-key="t-new">'+st+'</span>';
                        } else if (status == 1) {
                            status_value =
                                '<span id=' + data.id +
                        ...
                        table.row.add([
                            ...
                            data.legder_balance,
                            status_value,
                            "<a href='trip_board_salesOrder.php?no=" + data
                        .SaleOrder +
