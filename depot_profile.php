                    ...
                    <div class="row">
                                                ...
                                                <table
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">
                                                                <a href="depot_setups.php?id=<?php echo $_GET['id']; ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Tanks Status</h5>
                                    </div>
                            ...
                            <div class="col-xl-6">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title mb-0">Tanks stocks</h5>
                                    </div>
...
$(document).ready(function() {
    ...
    $('#setup_tag').attr('href', 'depot_setups.php?id=' + encodeURIComponent(encryptedId));
        ...
        .then(response => {
            ...
            if (response.length > 0) {
                ...
                $('#atgs').append('<div class="border-bottom loyal-customers-box pt-2">' +
                    ...
                    '<i class="fas fa-truck-moving font-size-14 text-dark ms-1"></i>' +
                    '<div class="flex-grow-1 ms-3 overflow-hidden">' +
                    '<h5 class="font-size-15 mb-1 text-truncate">No Stock Found</h5>' +
                    '</div>' +
                    '<div class="flex-shrink-0">' +
