                                    ...
                                    <div>
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3 d-none">
                                                <h6 class="mb-0 font-size-15"><small> Delivered </small>: <span
                                                        id="Pending_orders">0</span> </h6>
                                                <h6 class="mb-0 font-size-15"><small> Not-Delivered</small> : <span
        ...
        fetch("<?php echo $api_url; ?>get/get_all_main_orders.php?key=03201232927&pre=<?php echo $_SESSION['privilege'] ?>&user_id=<?php echo $_SESSION['user_id'] ?>",
            ...
            .then(response => {
                ...
                $.each(response, function(index, data) {
                    ...
                    track = (data.delivered_status == 1) ? "<a href='trip_board_salesOrder.php?no=" + data
                        .SaleOrder +
