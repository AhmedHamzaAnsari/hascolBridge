...
<body>
    ...
    function fetchtable() {
        ...
        fetch("<?php echo $api_url; ?>get/lubes/get_all_lubes_orders.php?key=03201232927&id=<?php echo $_SESSION['user_id'] ?>",
                requestOptions)
            ...
            .then(response => {
                ...
                $.each(response, function(index, data) {
                    table.row.add([
                        ...
                        data.total_amount,
                        data.created_at,
                        '<a href="lubes_order_invoice.php?id='+data.id+'" target="_blank"><i class="fas fa-file-invoice"></i></a>',
